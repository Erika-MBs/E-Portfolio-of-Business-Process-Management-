  ...
  **Description**
  ...
  ![Artefact 1](images/bpmn_art_1.png)
  ...
  **Reflection**
  I chose this artefact because it made me realise that SIPOC is not only effective in Six Sigma, but can also be integrated with Lean, Kaizen, and BPM. This was important because it showed that SIPOC can be used as a foundation before moving into more advanced tools. It also gave me a clearer idea of the order in which different tools and techniques are used in practice, depending on the industry and situation (Six Sigma, 2025).
  ...
  **Reflection**
  I chose this artefact because it helped me understand that Business Process Modelling is not just about making individual diagrams, but also about understanding how processes fit within the overall business strategy. This was important because it explained to me that processes need to be aligned with business goals, customer needs, and value generation. It also helped me recognise that modelling assists decision making, risk identification and performance improvement by connecting process design to a broader organisational and strategic perspective.
  
  
 ## Artefact 4: As-Is vs To-Be (Self-developed artefact)
  **Description**
  ...
  ![Artefact 4](images/as_is_TO_Be_art_4.png)
  ...
  **Reflection**
  I chose this artefact because it helped me realise that an As-Is and To-Be model is not created directly, but usually after applying tools such as SIPOC, BPMN, swimlane diagrams, or gap analysis to understand the current process and identify weaknesses. This made me understand that process modelling follows a logical sequence: first understanding the process, then identifying gaps, and finally redesigning it into a better To-Be version. This is important because modelling supports process redesign and continuous improvement.


## References
- ABPMP International 2019, *BPM CBOK® Version 4.0: Guide to the Business Process Management Common Body of Knowledge*, Association of Business Process Management Professionals, viewed 4 May 2026, <https://www.abpmp.org/page/guide_BPM_CBOK>.
- COIT20252 2026, *Process Transformation and Architecture – Week 7 Lecture*, CQUniversity.
- Lucid Software 2025, *BPMN tutorial video*, viewed 4 May 2026, <https://www.youtube.com/watch?v=6Juh83sxKkQ>.
- Six Sigma 2025, *SIPOC diagram and process mapping*, viewed 4 May 2026, <https://www.6sigma.us/process-mapping/sipoc-six-sigma/>.
...
![Process notes](images/process_notes_Portf_2.jpeg)

*Figure 5: Notes from my planning process showing how I selected and connected the artefacts for Business Process Modelling (Author’s own work, 2026).*
